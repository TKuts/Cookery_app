				...
				<div className="direction__block" >
					<p className="direction__block-title">ingredients for this step:</p>
					{
						elem.ingredients.length > 0 ?
							elem.ingredients.map(tool => (
								<p
									key={tool.id}
									className={elem.unwrap ? "direction__block-step" : "direction__block-step hiden"}
								>
									{tool.name}
								</p>
							)) :
